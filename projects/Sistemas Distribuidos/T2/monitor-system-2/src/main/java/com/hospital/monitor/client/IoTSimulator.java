...
public class IoTSimulator 
{
    ...
    public IoTSimulator(MqttClientService mqttClientService) 
    {
        this.mqttClientService = mqttClientService; // inscrever ao broker
    }

    // Método para gerar e publicar mensagens periodicamente
    @Scheduled(fixedRate = 160000) // Enviar mensagens a cada 160 segundos
    public void simulateDeviceData() 
    {
        String[] deviceIds = {"device123", "device456", "device789"};
